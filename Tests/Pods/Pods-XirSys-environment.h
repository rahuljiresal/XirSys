...
// XirSys
#define COCOAPODS_POD_AVAILABLE_XirSys
#define COCOAPODS_VERSION_MAJOR_XirSys 0
#define COCOAPODS_VERSION_MINOR_XirSys 1
#define COCOAPODS_VERSION_PATCH_XirSys 0
